...
window.Echo = new Echo({
  broadcaster: "reverb",
  key: "1be3c0c9-efe4-4c26-abdb-ac4c388d1411",
  wsHost: "druid.test",
  wsPort: "443",
  wssPort: "443",
  forceTLS: true,
...
createInertiaApp({
  ...
  resolve: (name) => resolvePageComponent(`./pages/${name}.vue`, /* @__PURE__ */ Object.assign({ "./pages/Dashboard.vue": () => import("./assets/Dashboard-BPHSRQN_.js"), "./pages/Welcome.vue": () => import("./assets/Welcome-C9xMziyQ.js"), "./pages/auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword-DnqKtAUQ.js"), "./pages/auth/ForgotPassword.vue": () => import("./assets/ForgotPassword-BFP-IX4n.js"), "./pages/auth/Login.vue": () => import("./assets/Login-h4gXG9NZ.js"), "./pages/auth/Register.vue": () => import("./assets/Register-WX2ETWz2.js"), "./pages/auth/ResetPassword.vue": () => import("./assets/ResetPassword-hEwh1az_.js"), "./pages/auth/VerifyEmail.vue": () => import("./assets/VerifyEmail-DStxjuDX.js"), "./pages/settings/Appearance.vue": () => import("./assets/Appearance-DfDVK5H7.js"), "./pages/settings/Password.vue": () => import("./assets/Password-4V1dvGGZ.js"), "./pages/settings/Profile.vue": () => import("./assets/Profile-RAPyFgxT.js") })),
  setup({ el, App, props, plugin }) {
    createApp({ render: () => h$1(App, props) }).use(plugin).use(k, Ziggy$1).component("Head", Head).component("Link", Link).mount(el);
  },
  progress: {
    color: "#4B5563"
  }
