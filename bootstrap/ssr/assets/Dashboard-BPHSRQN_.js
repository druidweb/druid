...
import { _ as _sfc_main$2 } from "./AppLayout-Pm2NQ-CK.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$2, { breadcrumbs }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4"${_scopeId}><div class="grid auto-rows-min gap-4 md:grid-cols-3"${_scopeId}><div class="border-sidebar-border/70 relative aspect-video overflow-hidden rounded-xl border dark:border-sidebar-border"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$1, null, null, _parent2, _scopeId));
            _push2(`</div><div class="border-sidebar-border/70 relative aspect-video overflow-hidden rounded-xl border dark:border-sidebar-border"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$1, null, null, _parent2, _scopeId));
            _push2(`</div><div class="border-sidebar-border/70 relative aspect-video overflow-hidden rounded-xl border dark:border-sidebar-border"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$1, null, null, _parent2, _scopeId));
            _push2(`</div></div><div class="border-sidebar-border/70 relative min-h-[100vh] flex-1 rounded-xl border dark:border-sidebar-border md:min-h-min"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$1, null, null, _parent2, _scopeId));
            _push2(`</div></div>`);
          } else {
            return [
              createVNode("div", { class: "flex h-full flex-1 flex-col gap-4 rounded-xl p-4" }, [
                createVNode("div", { class: "grid auto-rows-min gap-4 md:grid-cols-3" }, [
                  createVNode("div", { class: "border-sidebar-border/70 relative aspect-video overflow-hidden rounded-xl border dark:border-sidebar-border" }, [
                ...
                createVNode("div", { class: "border-sidebar-border/70 relative min-h-[100vh] flex-1 rounded-xl border dark:border-sidebar-border md:min-h-min" }, [
                  createVNode(_sfc_main$1)
                ])
              ])
            ];
