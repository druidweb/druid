...
import { a as _sfc_main$3 } from "./AppLayout-Pm2NQ-CK.js";
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (_ctx.description) {
        _push(`<p class="text-sm text-muted-foreground">${ssrInterpolate(_ctx.description)}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</header>`);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><div class="mb-8 space-y-0.5"><h2 class="text-xl font-semibold tracking-tight">${ssrInterpolate(_ctx.title)}</h2>`);
      if (_ctx.description) {
        _push(`<p class="text-sm text-muted-foreground">${ssrInterpolate(_ctx.description)}</p>`);
      } else {
        _push(`<!---->`);
