...
import { c as cn, _ as _sfc_main$19, a as _sfc_main$1a } from "./AppLogoIcon-xe2zDqH9.js";
...
import { _ as _sfc_main$18 } from "./Input-D5Mz7eRZ.js";
                              ...
                              if (_push5) {
                                _push5(ssrRenderComponent(unref(_sfc_main$K), {
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<a${ssrRenderAttr("href", item.url)} target="_blank" rel="noopener noreferrer"${_scopeId5}>`);
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(unref(_sfc_main$K), {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<a${ssrRenderAttr("href", _ctx.route("dashboard"))}${_scopeId5}>`);
                      ...
                      _push3(ssrRenderComponent(unref(_sfc_main$7), null, {
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            ...
                            return [
                              index === _ctx.breadcrumbs.length - 1 ? (openBlock(), createBlock(unref(_sfc_main$4), { key: 0 }, {
                                default: withCtx(() => [
                                  createTextVNode(toDisplayString(item.title), 1)
                                ]),
                                _: 2
                    ...
                    return [
                      (openBlock(true), createBlock(Fragment, null, renderList(_ctx.breadcrumbs, (item, index) => {
                        return openBlock(), createBlock(Fragment, { key: index }, [
                          ...
                          index !== _ctx.breadcrumbs.length - 1 ? (openBlock(), createBlock(unref(_sfc_main$3), { key: 0 })) : createCommentVNode("", true)
                        ], 64);
                      }), 128))
                    ];
                  }
