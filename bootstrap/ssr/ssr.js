...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => resolvePageComponent(`./pages/${name}.vue`, /* @__PURE__ */ Object.assign({ "./pages/Dashboard.vue": () => import("./assets/Dashboard-TpOJJUV9.js"), "./pages/Welcome.vue": () => import("./assets/Welcome-Dr-7jBvn.js"), "./pages/auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword-S2-kOm5M.js"), "./pages/auth/ForgotPassword.vue": () => import("./assets/ForgotPassword-LpQXfrZe.js"), "./pages/auth/Login.vue": () => import("./assets/Login-DnVDeqzE.js"), "./pages/auth/Register.vue": () => import("./assets/Register-DLt18i6O.js"), "./pages/auth/ResetPassword.vue": () => import("./assets/ResetPassword-P7ffJtne.js"), "./pages/auth/VerifyEmail.vue": () => import("./assets/VerifyEmail-pCzTrb1P.js"), "./pages/settings/Appearance.vue": () => import("./assets/Appearance-Dzkt3rle.js"), "./pages/settings/Password.vue": () => import("./assets/Password-D-MJlc3S.js"), "./pages/settings/Profile.vue": () => import("./assets/Profile-D_Aq4bAU.js") })),
